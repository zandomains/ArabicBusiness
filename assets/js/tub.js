...
const VIDEOS = [
  ...
  { id:'v1', 
    ...
    title:'اطلب فتح الفيديو - كيف تجعل الزبون يشتري وهو غير مهتم', 
  ...
  { id:'v2', 
    driveId:'1jNib-Y7daXwrt96UNmGnreGueOplODvi', 
    title:'ماكينات صناعية صينية مربحة من شهرها الأول', 
    desc:'إذا كنت تبحث عن فكرة مشروع مربح برأس مال متوسط، فنحن نستعرض لك في هذا الفيديو قائمة بأفضل الماكينات الصناعية الصينية التي أثبتت كفاءتها العالية في السوق، وتفردت بقدرتها على تحقيق أرباح ملموسة منذ الشهر الأول للتشغيل. فقد تجاوزت الصناعة الصينية مفهوم السعر المنخفض لتصبح اليوم مزوداً لحلول ذكية ومبتكرة تناسب المشاريع الصغيرة والمتوسطة؛ لذا سنغوص اليوم في تفاصيل مواصفات كل ماكينة وقدرتها الإنتاجية، مع تسليط الضوء على كيفية استيرادها من الصين بأمان، بالإضافة إلى تقديم نصائح جوهرية تساعدك في اختيار الماكينة المثالية التي تتوافق مع ميزانيتك ومساحة عملك، مدعومة بدراسة جدوى سريعة لكل مشروع لضمان انطلاقة قوية وناجحة.',
    category:'business', 
    catLabel:'ريادة الأعمال', 
    instructor:'الأستاذ محمد عادل', 
    initial:'MA', 
    dur:'06:31 دقيقة', 
    views:'567', 
    date:'AraBusinessTube', 
