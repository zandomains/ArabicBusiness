...
════════════════════════════════════════ */
const VIDEOS = [
  { id:'v1', driveId:'1hZWbke7BukA7UsWjIPXphdgtj47lNskv', title:'حيل نفسية في التسويق تجعل الزبون يشتري.. حتى لو لم يكن مهتم ', desc:'هل تساءلت يوماً لماذا تشتري أشياء لم تكن تخطط لشرائها؟ أو لماذا تشعر برغبة ملحة في اقتناء منتج معين بمجرد رؤية إعلان له؟ في هذا الفيديو، نغوص في عالم "علم النفس التسويقي" لنكشف لك أقوى الحيل والتقنيات التي تستخدمها كبرى الشركات العالمية للتأثير على قرارات الشراء لدى المستهلكين. سنشرح لك كيف يمكنك كصاحب مشروع أو مسوق استخدام هذه الاستراتيجيات الأخلاقية لزيادة مبيعاتك وإقناع العميل بجدوى منتجك حتى لو كان متردداً.', category:'business', catLabel:'ريادة الأعمال', instructor:'نبيل يوسف', initial:'ع', dur:'15 دقيقة', views:'١٢,٤٥٠', date:'منذ ٣ أيام', badge:'جديد', tags:['ريادة الأعمال','بناء المشاريع','التخطيط الاستراتيجي'], emoji:'🚀', grad:'linear-gradient(135deg,#1a2a4a,#0d1a30)' },
  { id:'v2', driveId:'1ThSzFyzbjR2UoQQcgrySw4jKjNZ8_EMy', title:'كيف تتعلم برمجة المواقع الرقمية بدون شهادة جامعية', desc:'هل تساءلت يوماً لماذا تشتري أشياء لم تكن تخطط لشرائها؟ أو لماذا تشعر برغبة ملحة في اقتناء منتج معين بمجرد رؤية إعلان له؟ في هذا الفيديو، نغوص في عالم "علم النفس التسويقي" لنكشف لك أقوى الحيل والتقنيات التي تستخدمها كبرى الشركات العالمية للتأثير على قرارات الشراء لدى المستهلكين. سنشرح لك كيف يمكنك كصاحب مشروع أو مسوق استخدام هذه الاستراتيجيات الأخلاقية لزيادة مبيعاتك وإقناع العميل بجدوى منتجك حتى لو كان متردداً.', category:'business', catLabel:'ريادة الأعمال', instructor:'نبيل يوسف', initial:'ع', dur:'15 دقيقة', views:'١٢,٤٥٠', date:'منذ ٣ أيام', badge:'جديد', tags:['ريادة الأعمال','بناء المشاريع','التخطيط الاستراتيجي'], emoji:'🚀', grad:'linear-gradient(135deg,#1a2a4a,#0d1a30)' },
  { id:'v3', driveId:'14smOIrkjPstrwo4Q8_pkaAOlYMiIQ5kq', title:'الحلقة الأولى- التكوين التطبيقي', desc:'هل تساءلت يوماً لماذا تشتري أشياء لم تكن تخطط لشرائها؟ أو لماذا تشعر برغبة ملحة في اقتناء منتج معين بمجرد رؤية إعلان له؟ في هذا الفيديو، نغوص في عالم "علم النفس التسويقي" لنكشف لك أقوى الحيل والتقنيات التي تستخدمها كبرى الشركات العالمية للتأثير على قرارات الشراء لدى المستهلكين. سنشرح لك كيف يمكنك كصاحب مشروع أو مسوق استخدام هذه الاستراتيجيات الأخلاقية لزيادة مبيعاتك وإقناع العميل بجدوى منتجك حتى لو كان متردداً.', category:'business', catLabel:'ريادة الأعمال', instructor:'نبيل يوسف', initial:'ع', dur:'15 دقيقة', views:'١٢,٤٥٠', date:'منذ ٣ أيام', badge:'جديد', tags:['ريادة الأعمال','بناء المشاريع','التخطيط الاستراتيجي'], emoji:'🚀', grad:'linear-gradient(135deg,#1a2a4a,#0d1a30)' },
